...
public class ModificationInventaire extends JDialog {
    JDialog dialog;
    JLabel labNom;
    JTextField txfNom;
    JLabel labSerie;
    ...
    public static void ModificationInventaire(String[] args) {
        new ModificationInventaire();
    }
}
